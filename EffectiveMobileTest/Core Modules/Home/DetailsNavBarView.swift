...
protocol DetailsNavBarViewProtocol: AnyObject {
    func didTapBack()
    func didTapBasket()
}

final class DetailsNavBarView: UIView {
    
    public weak var delegate: DetailsNavBarViewProtocol?
...
private extension DetailsNavBarView {
    func setup() {
